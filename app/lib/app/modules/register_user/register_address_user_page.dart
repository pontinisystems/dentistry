...
class RegisterAddressUserPage extends StatefulWidget {
  final String title;
  const RegisterAddressUserPage({Key key, this.title = "RegisterUser"})
      : super(key: key);

  @override
  _RegisterAddressUserPageState createState() => _RegisterAddressUserPageState();
}



class _RegisterAddressUserPageState
    extends ModularState<RegisterAddressUserPage, RegisterUserController>   with LoaderMixin {
